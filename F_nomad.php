...
<h1>Temporal Command Suite <sub>(Technology)</sub></h1>
    ...
    <ol><li><i>Temporal Command Suite</i> may allow the Nomad player may perform a transaction at a time they usually could not. For example, if the Mentak player exhausts their Suffi An agent during the strategy phase when another player gains the trade goods on the strategy card they chose, the Nomad player may use <i>Temporal Command Suite</i> and then perform a transaction with the Mentak player.</li></ol>
...
<h1>Navarch Fend <sub>(Commander)</sub></h1>
    <ol class="note">
    <li>Producing the <i>Memoria</i> still counts towards <sc>Production</sc> limits.</li>
    </ol>
