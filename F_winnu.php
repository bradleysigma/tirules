...
<h1>Mathis Mathinus &mdash; Imperial Seal <sub>(Hero)</sub></h1>
    ...
    <li>If the Winnu player chooses the <i>Trade</i> strategy card for this ability and the Winnu player chooses a player to resolve the secondary without spending a command token via the primary ability, the chosen player must resolve the secondary ability. Additionally, if th Winnu player chooses a player to resolve the secondary via the Hero&rsquo;s ability, it is optional for that player to resolve the secondary, but if they do, they must spend a strategy token to do so.</li>
