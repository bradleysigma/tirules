...
<h1>Salai Sai Corain <sub>(Flagship)</sub></h1>
    <ol class="note">
    <li>During a combat against the Nekro player in a system containing each player&rsquo;s flagships, the <i>Salai Sai Corain</i> will count the Nekro player&rsquo;s infantry participating in the combat when determining how many dice to roll.</li>
    </ol>
...
<h1>Mathis Mathinus &mdash; Imperial Seal <sub>(Hero)</sub></h1>
    ...
    <li>If the Winnu player chooses the <i>Trade</i> strategy card for this ability, if the Winnu player chooses a player to resolve the secondary without spending a command token via the primary ability, the chosen player must resolve the secondary ability. Additionally, if Winnu player chooses a player to resolve the secondary via the Hero&rsquo;s ability, it is optional for that player to resolve the secondary, but if they do, they must spend a strategy token to do so.</li>
...
<h1>Reclaimer <sub>(Mech)</sub></h1>
    ...
    <li>If the Winnu player gains control of a planet with multiple Reclaimer, they may place a structure for each one, if they may do so without exceeding the maximum number of that structure allowed on a planet.</li>
    </ol>
</article>
