...
<h1>Radical Advancement <sub>(Technology)</sub></h1>
    ...
    <li>The Deepwrought player may replace <i>Radical Advancement</i> itself for a green technology with two prerequisites.</li>
    </ol>
...
<h1>Ta Zern &mdash; Wave Function Collapse <sub>(Hero)</sub></h1>
    <ol class="note">
    <li>The Deepwrought player too will research another technology.</li>
...
<h1>Visionaria Select <sub>(Breakthrough)</sub></h1>
    <ol class="note">
    <li>When <i>Visionaria Select</i> is exhausted, all other players have the opportunity to participate; the Deepwrought player cannot choose a subset of players to participate</li>
