...
<h1>Dark Pact <sub>(Promissory Note)</sub></h1>
    ...
    <li>The trade goods gained from <i>Dark Pact</li> are gained simultaniously with the commodities transacted between the two players is resolved. As a pair of players is limited to one transaction per turn (which must involve the active player) or per agenda, the two players cannot then perform a transaction for these trade goods on the same turn.</li>
    <li>As the trade goods from <i>Dark Pact</li> are gained simultaniously with and commodities and/or trade goods transacted, the Mentak player may only use their <sc>Pillage</sc> ability on each player once per <i>Dark Pact</i> transaction.</li>
