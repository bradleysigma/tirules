...
<h1>Ceasefire</h1>
    ...
    <li>If the active player already has units with capacity in the active system, they may transport them into the space area of that system. Those units may then be committed to invade a planet during this tactical action.</li>
    <li>If a player has moved units into the active system before their <i>Ceasefire</i> is played, those units will remain in the active system.</li>
