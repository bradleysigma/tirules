...
<h1>Vortex <sub>(Technology)</sub></h1>
    <ol class="note">
    <li>A unit is not adjacent to the system it is in; the <i>Vortex</i> ability cannot target a unit that is blockading one of the Vuil&rsquo;raith player&rsquo;s Dimensional Tears, unless there is a second space dock in an adjacent system.</li>
...
<h1>Reanimator <sub>(Mech)</sub></h1>
    <ol class="note">
    <li>If the Vuil&rsquo;riath player owns the Infantry II unit upgrade technology, and one is destroyed during on a planet with a Reanimator, the Vuil&rsquo;raith player captures an infantry token, and they roll for resurrection, placing the destroyed infantry on the Infantry II unit upgrade card if successful.</li>
    <li>If Vuil&rsquo;riath player&rsquo;s infantry in a planet with a Reanimator are destroyed outside of combat, such as the <i>Plague</i> action card, those infantry will be captured.</li>
    </ol>
</article>
